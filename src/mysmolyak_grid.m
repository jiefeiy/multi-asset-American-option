function [S,C] = mysmolyak_grid(N,w,knots,lev2knots,idxset,S2,arg7) %#ok<INUSD>
...
if w==0
    ...
    S=struct('knots',empty_cells,'knots_in',empty_cells,'weights',empty_cells,'size',empty_cells,'size_in',empty_cells,...
        'knots_per_dim',empty_cells,'m',empty_cells);
