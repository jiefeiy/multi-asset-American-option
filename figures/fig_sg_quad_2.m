...
plot(N_Q, err2_Q,'DisplayName','Gauss Hermite, L^{interp} = 6',...
...
N_Q_i7 = [89   137   201   281   381   501   645   813   1009 ...
    1233   1489   1777];
hold on; plot(N_Q_i7, err2_Q_i7,'DisplayName','Gauss Hermite, L^{interp} = 7',...
...
hold on; plot(N_Q_leja, err2_leja,'DisplayName','normal Leja, L^{interp} = 6',...
...
hold on; plot(N_Q_leja_i7, err2_leja_i7,'DisplayName','normal Leja, L^{interp} = 7',...
...
hold on; plot(N_Q_GK, err2_GK,'DisplayName','Genz-Keister, L^{interp} = 6',...
